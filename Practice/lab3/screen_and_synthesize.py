...
# 文件路径
input_file = '/workspaces/Comm2026/Practice/lab3/academic_search_results_1763103698702.csv'
output_dir = '/workspaces/Comm2026/Practice/lab3/output'
output_csv = os.path.join(output_dir, 'academic_search_results_with_genai.csv')
